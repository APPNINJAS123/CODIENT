...
import { FileIcon, FolderIcon, SquareChevronRightIcon } from "lucide-react";
            ...
            <Sidebar collapsible="none" className="w-full">
                <SidebarContent>
                    <SidebarGroup>
                        <SidebarGroupContent>
                            <SidebarMenu>
                              {data.map((item,index)=><Tree key={index} item={item} selectedValue={value} onSelect={onSelect} parentPath=""/>)  }
                            </SidebarMenu>
                        </SidebarGroupContent>
                    </SidebarGroup>
                </SidebarContent>
...
const Tree=({item,selectedValue,onSelect,parentPath}:TreeProps)=>{
    ...
    return(
        <SidebarMenuItem>
            ...
            <SidebarMenuButton>
               <SquareChevronRightIcon className="transition-transform"/>
                <FolderIcon/>
                <span className="truncate">{name}</span>
